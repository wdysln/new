...
license @ LGPL
src_url @ http://download.kde.org/stable/applications/15.08.2/src/ark-$version.tar.xz
http://download.kde.org/stable/applications/15.08.2/src/dolphin-$version.tar.xz
http://download.kde.org/stable/applications/15.08.2/src/kate-$version.tar.xz
arch @ ~x86_64
"""
