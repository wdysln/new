...
license @ LGPL
src_url @ http://download.kde.org/stable/frameworks/5.15/plasma-framework-$version.tar.xz
...
depends = """
build @ kde5-base/kde5-framework12 net-misc/networkmanager
"""
srcdir = "."

#get("main/cmake_utils")

names = ["plasma-framework",
		"kjsembed"]
