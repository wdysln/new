...
license @ LGPL
src_url @ http://download.kde.org/stable/frameworks/5.15/kded-5.15.0.tar.xz
http://download.kde.org/stable/frameworks/5.15/ktexteditor-5.15.0.tar.xz
arch @ ~x86_64
"""

depends = """
build @ kde5-base/kde5-framework13 net-misc/networkmanager
"""
srcdir = "."
